...
data_3=[0 0;1 1];
sp=30;                                     %to increase the speed of simulation
N= randi([2 8],1);  
...
legend(txt_legend)
title("Sum of the energy of the system"+", Restitution: "+ c_r)
xlabel("Time (s)")
ylabel("Energy (J)")
axis([0 1 0 150])
grid on
...
plot(fps, data(:,1),"linewidth",3)
for i=[1:N]
    plot(fps,ener(:,i),"linewidth",1.5)
    txt_legend(i+1)={"Object " + i};
end
title("Energy Values of "+N+ " Object"+", Restitution: "+ c_r)
legend(txt_legend)
xlabel("Time (s)")
ylabel("Energy (J)")
axis auto